...
public class AustrianIBan extends IBanGenerator {

	private static final String COUNTRY_CODE = Country.AUSTRIA.value();
	
	private static final long COUNTRY_CODE_DIGIT_REPRESENTATION = 1029;
	
	private static final long BANK_CODE_LENGTH_MIN = 10000;
	
	private static final long BANK_CODE_LENGTH_MAX = 100000;

	private static final long ACCOUNT_NUMBER_LENGTH_MIN = 10000000000L;
	
	private static final long ACCOUNT_NUMBER_LENGTH_MAX = 100000000000L;
